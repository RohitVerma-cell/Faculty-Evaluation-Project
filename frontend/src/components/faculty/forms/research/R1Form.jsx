...
// ── Sab blank — faculty khud select kare ──
const EMPTY = () => ({
  id: String(Date.now() + Math.random()),
  title: '', journalName: '', issnNumber: '',
  yearOfPublication: '', indexing: '',
  authorshipPosition: '', volumeIssue: '',
  proof: null,
});
      ...
      {entries.map((entry, i) => (
        <div key={entry.id} style={styles.card}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
            <h3 style={{ fontSize: 14, fontWeight: 600, margin: 0, color: 'var(--text-main,#0f172a)' }}>Journal Paper #{i + 1}</h3>
          ...
          <div style={styles.grid}>
            ...
            <div>
              ...
              <select style={styles.input} value={entry.authorshipPosition}
                ...
                <option value="1st">1st Author</option>
                <option value="2nd">2nd Author</option>
              </select>
            </div>
            <div>
