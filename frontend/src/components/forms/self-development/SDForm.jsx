...
export function SD1Form({ entries, setEntries }) {
  return (
    <TableForm
      ...
      emptyTemplate={{ title:'', organizingInstitute:'', numberOfDays:'', dates:'' }}
      columns={[
...
export function SD2Form({ entries, setEntries }) {
  return (
    <TableForm
      ...
      emptyTemplate={{ title:'', organizingInstitute:'', numberOfWeeks:'', dates:'' }}
      columns={[
...
export function SD4Form({ entries, setEntries }) {
  return (
    <TableForm
      ...
      emptyTemplate={{ title:'', provider:'', duration:'', startDate:'', completionDate:'' }}
      columns={[
...
export function SD6Form({ entries, setEntries }) {
  return (
    <TableForm
      ...
      emptyTemplate={{ awardTitle:'', organizationName:'', scope:'National', dateOfAward:'' }}
      columns={[
