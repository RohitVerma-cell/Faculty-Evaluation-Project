...
import { useStore, usePendingCount } from '../context/useStore'
...
const NAV_ITEMS = [
  ...
  { to: '/HOD/approvals',   label: 'Pending Approvals', Icon: Clock,    badge: 'pending' },
  { to: '/HOD/evaluation',  label: 'Evaluation',        Icon: Star,     badge: 'NEW' },
  { to: '/HOD/performance', label: 'Faculty Performance',Icon: Award },
  { to: '/HOD/analytics',   label: 'Analytics',         Icon: BarChart3 },
]

const PAGE_TITLES = {
  '/HOD/dashboard':     'Dashboard',
  '/HOD/approvals':   'Pending Approvals',
  '/HOD/evaluation':  'Evaluation',
  '/HOD/performance': 'Faculty Performance',
    ...
    <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-200">
      ...
      <aside className={[
        ...
        <div className="flex items-center gap-3 px-4 h-16 border-b border-slate-200 dark:border-slate-800 flex-shrink-0">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-600 to-violet-600 flex items-center justify-center text-white font-bold text-base flex-shrink-0">
            H
          </div>
          {!sidebarCollapsed && (
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Navbar */}
        <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center px-5 gap-4 flex-shrink-0 z-30">
          <button
